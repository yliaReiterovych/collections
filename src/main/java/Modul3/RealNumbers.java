...
import java.util.ArrayList;
    ...
    public class RealNumbers {
        public static void main(String[] args) {
            ...
            System.out.print("Колекція дійсних чисел ");
            printArrayList(list);
        ...
        public static void sumNegativeElements(ArrayList<Integer> list) {
            ...
            System.out.println("Сума негативних елементів " + sum);
        }
        ...
        public static void multiplicationBetweenMinimumMaximum(ArrayList<Integer> list) {
            ...
            System.out.println("добуток між елементами мін і макс " + multi + " (між" + startRange + " і " + endRange + " елементом)");
        }
        ...
        public static void multiplicationEvenElements(ArrayList<Integer> list) {
            ...
            System.out.println("сума парних елементів " + multi);
        }
        ...
        public static void sumBetweenFirstLastNegativeElement(ArrayList<Integer> list) {
            ...
            System.out.println("Сума між першим і останнім елементом " + sum);
        }
        ...
        public static void bubbleSort(ArrayList<Integer> list) {
            ...
            System.out.print("Сортування бульбашок ");
            printArrayList(list);
        }
    }
