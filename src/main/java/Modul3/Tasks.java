...
import java.util.Random;
    ...
    public class Tasks {
        public static void main(String[] args) {
            ArrayList list = generateArrayList();
        ...
        public static void findMinimum(ArrayList<Integer> list) {
            ...
            System.out.print("Мінімум в колекції: " + listMinimum);
            ...
            System.out.println(" (кількість: " + countListMinimum + ")");
        }
        ...
        public static void findMaximum(ArrayList<Integer> list) {
            ...
            System.out.print("Максимум в колекції: " + listArrayMaximum);
            ...
            System.out.println(" (кількість: " + countListMaximum + ")");
        }
        ...
        public static void primeNumbers(ArrayList<Integer> list) {
            System.out.print("Прості числа в колекції: ");
            ...
            System.out.println("(колькість: " + countPrimeNumbers + ")");
        }
    }
